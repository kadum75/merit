  ...
  return (
    <>
      {!isSupabaseConfigValid && (
        <div className="bg-red-600 text-white py-2 px-4 text-center text-sm font-bold sticky top-0 z-[100] flex items-center justify-center gap-2">
          <Lock className="w-4 h-4" />
          Supabase is not configured. Sign-in and Pro features will be disabled. 
          <span className="hidden sm:inline opacity-80 font-normal ml-2">Please set VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY.</span>
        </div>
      )}
      ...
      <footer className="py-6 px-6 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <p className="text-sm text-zinc-500">© 2026 <a href="https://zenstack.netlify.app" target="_blank" rel="noopener noreferrer" className="hover:text-amber-500 transition-colors">ZenStack</a>. All rights reserved.</p>
