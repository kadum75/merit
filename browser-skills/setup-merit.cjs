 ...
 * and writes .env.
 *
 * Usage: node browser-skills/setup-merit.cjs
 */
...
async function main() {
  ...
  console.log('  (Click "New Token", name it "merit-setup", copy the token)');
  ...
  console.log('  Create products named "Merit Monthly" and "Merit Annual" if not yet created.');
...
`;
  ...
  //  5. SAVE AS SKILL
  // ────────────────────────────────────────────
  const skillContent = `# Merit Setup Skill
# Generated by browser-skills/setup-merit.cjs
...
## How to re-run
  node browser-skills/setup-merit.cjs
...
`;
  ...
  // ────────────────────────────────────────────
  console.log('\n═══════════════════════════════════════════');
  console.log('  ✓ Merit setup complete!');
